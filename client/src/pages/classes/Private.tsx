...
import { Clock, Star, Target, Zap, Calendar, CheckCircle, User, Trophy } from "lucide-react"
import privateImage from "@/assets/edu-real.jpg"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            ...
            <div>
              <div className="relative">
                <img 
                  src={privateImage} 
                  alt="Master instructor providing personalized instruction"
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Choose the package that best fits your schedule, budget, and training goals. 
              All packages include flexible scheduling and personalized instruction.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {packages.map((pkg, index) => (
              <Card key={index} className={`border-0 shadow-elegant hover-lift relative ${pkg.popular ? 'ring-2 ring-secondary transform scale-105' : ''}`}>
                {pkg.popular && (
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button 
                    asChild 
                    className={`w-full ${pkg.popular ? 'bg-secondary hover:bg-secondary/90 text-secondary-foreground' : ''}`}
                    variant={pkg.popular ? 'default' : 'outline'}
                  >
                    <Link to="/join">Select Package</Link>
                  </Button>
                </CardContent>
              </Card>
            ))}
