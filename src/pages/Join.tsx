...
const Join = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Using EmailJS for form submission (frontend-only solution)
      const templateParams = {
        to_name: "Nairobi TKD Admin",
      ...
      await emailjs.send(
        "service_0ayo19h", // EmailJS service ID
        "n3s5d4e", // EmailJS template ID
        templateParams,
        "YG5OTMHMqPXhtbobk" // EmailJS public key
      );
